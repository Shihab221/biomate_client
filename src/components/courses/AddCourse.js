...
const AddCourse = () => {
  ...
  const courseDataToEdit = ["title", "description", "fee"];
  ...
  const labels = ["Title", "Description", "Fee"];
  ...
  return (
    <div className="flex items-center justify-center m-10">
      <Card className="max-w-[600px] p-10 margin-auto">
        <input
          type="file"
        ...
        <div className={classes.addCourseContainer}>
          <h2 className="bg-slate-400 py-8 ">Add Course</h2>
        </div>
